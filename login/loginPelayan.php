<?php
session_start();
require '../Koneksi.php'; // Mengimpor file koneksi database
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT * FROM pelayan WHERE namaPelayan = '$username' AND passwordPelayan = '$password'"; 
    $result = $conn->query($sql); 
    
    if ($result->num_rows > 0) { 
        $_SESSION['username'] = $username; 
        header("Location: ../dashboard/pelayan/menuUtamaPelayan.php"); 
    } else {
    ...
    <div class="flex w-3/4 max-w-4xl bg-white shadow-lg overflow-hidden relative rounded-2xl">
        ...
        <div class="w-1/2 p-10">
            <div class="flex flex-col items-center">
                ...
                <h1 class="text-2xl font-bold mb-2">Log In Pelayan</h1>
