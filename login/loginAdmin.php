...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT * FROM adminresto WHERE namaAdmin = '$username' AND passwordAdmin = '$password'"; 
    ...
    <div class="flex w-3/4 max-w-4xl bg-white shadow-lg overflow-hidden relative rounded-2xl">
        ...
        <div class="w-1/2 p-10">
            <div class="flex flex-col items-center">
                ...
                <h1 class="text-2xl font-bold mb-2">Log In Admin</h1>
